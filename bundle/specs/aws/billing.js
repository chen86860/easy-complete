var e={name:"billing",description:"You can use the Billing API to programatically list the billing views available to you for a given time period. A billing view represents a set of billing data.  The Billing API provides the following endpoint:  https://billing.us-east-1.api.aws",subcommands:[{name:"list-billing-views",description:"Lists the billing views available for a given time period.  Every Amazon Web Services account has a unique PRIMARY billing view that represents the billing data available by default. Accounts that use Billing Conductor also have BILLING_GROUP billing views representing pro forma costs associated with each created billing group",options:[{name:"--active-time-range",description:"The time range for the billing views listed. PRIMARY billing view is always listed. BILLING_GROUP billing views are listed for time ranges when the associated billing group resource in Billing Conductor is active. The time range must be within one calendar month",args:{name:"structure"}},{name:"--max-results",description:"The maximum number of billing views to retrieve. Default is 100",args:{name:"integer"}},{name:"--next-token",description:"The pagination token that is used on subsequent calls to list billing views",args:{name:"string"}},{name:"--cli-input-json",description:"Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally",args:{name:"string"}},{name:"--starting-token",description:`A token to specify where to start paginating.  This is the
