...
help text`},{name:"SEARCH_TERMS",description:`Search terms. The command will return a list of gcloud commands that are
...
+
+
The '--' argument must be specified between gcloud specific args on the left and SEARCH_TERMS on the right`}]},t=e;export{t as default};
