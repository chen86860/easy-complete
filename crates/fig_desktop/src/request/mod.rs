...
use fig_proto::fig::{
    CheckForUpdatesRequest, CheckForUpdatesResponse, ClientOriginatedMessage, DragWindowRequest, InsertTextRequest,
    NotificationRequest, OnboardingRequest, PositionWindowRequest, RunProcessRequest, ServerOriginatedMessage,
